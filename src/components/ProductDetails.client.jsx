		...
		<>
			<ProductProvider data={product} initialVariantId={initialVariant.id}>
				<div className="grid grid-cols-1 md:grid-cols-[1fr,1fr] gap-x-8 my-16">
					...
					<div>
						<div className="hidden md:block">
							...
							/>
							<div className="bg-hydro-blue w-7/12 h-1.5 shadow mb-2"></div>
							<ProductPrice
								className="text-gray-500 line-through text-lg font-semibold"
								priceType="compareAt"
								variantId={initialVariant.id}
				...
				<Suspense fallback={<BoxFallback />}>
					<div className="bg-white p-4 shadow-xl rounded-xl mb-10">
						<h2 className='text-2xl font-bold text-black mb-1'>You might also like:</h2>
