						...
						<>
							...
							<Listbox.Options className="absolute z-10 mt-2">
								<div className="bg-white p-4 rounded-lg drop-shadow-2xl overflow-y-auto h-64">
									<Listbox.Option
										disabled
										className="p-2 text-md text-left text-black font-medium uppercase"
									>
										Country
									</Listbox.Option>
									{!countries.length ? (
									...
									{countries.map((country) => {
										...
										return (
											...
											>
												{({ active }) => (
													<div
														className={`w-36 py-2 px-3 flex justify-between items-center text-left cursor-pointer rounded text-black
